...
class GeneralizedLinearRegressor: public Regressor
{
  ...
  public:
    ...
    // Constructor
    GeneralizedLinearRegressor (int dim, int degree=1, double lambda=0.0);
    // Destructor
    ~GeneralizedLinearRegressor ();
    // Copy constructor
    GeneralizedLinearRegressor (const GeneralizedLinearRegressor & other);
    // Copy assignment operator
    void swap (GeneralizedLinearRegressor & temp);
    GeneralizedLinearRegressor & operator = (const GeneralizedLinearRegressor & other);
    // Move constructor
    GeneralizedLinearRegressor (GeneralizedLinearRegressor && other);
    // Move assignment operator
    GeneralizedLinearRegressor & operator = (GeneralizedLinearRegressor && other);
