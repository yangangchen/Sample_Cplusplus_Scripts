...
*/
int PolynomialRegressor::transform_dim (int input_dim, int input_degree) const {
    int output_dim = 1;
...
Eigen::MatrixXi PolynomialRegressor::build_expn_table_partial (int input_dim,
                                                               int expn_sum) const {
    if (expn_sum == 0) {
...
PolynomialRegressor::PolynomialRegressor (int dim, int degree, double lambda):
...
PolynomialRegressor::PolynomialRegressor (const PolynomialRegressor & other):
    Regressor{other}, degree{other.degree},
    tf_dim{other.tf_dim}, lambda{other.lambda}, W{other.W} {
}

// Copy-and-swap-idiom
void PolynomialRegressor::swap(PolynomialRegressor & temp)
{
    using std::swap;
    Regressor::swap(temp);
...
PolynomialRegressor & PolynomialRegressor::operator = (const PolynomialRegressor & other)
{
    PolynomialRegressor temp = other;
    swap(temp);
    return *this;
}

PolynomialRegressor::PolynomialRegressor (PolynomialRegressor && other):
...
PolynomialRegressor & PolynomialRegressor::operator = (PolynomialRegressor && other)
{
    using std::swap;
